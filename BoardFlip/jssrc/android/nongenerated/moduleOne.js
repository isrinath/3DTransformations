...
function moveContainer(txtArrNo) {
    ...
    frmHome.flexDummy.animate(kony.ui.createAnimation({
        100: {
            transform: trans
        }
    }), {
...
function moveContainerNew(txtArrNo) {
    ...
    var trans = kony.ui.makeAffineTransform();
    var devInfo = kony.os.deviceInfo();
    if (devInfo.name === "android") trans.translate(-(devInfo.screenWidth), 0);
    else trans.translate3D(-(devInfo.screenWidth), 0, 0);
    ...
    var txt = "Most of us need a holiday after a holiday with the kids, but a family trip need not be so painful. While you and your partner might be craving the turquoise waters of Bora Bora this summer, you might want to reconsider this as a destination if you’ve got the youngsters in tow. To ease the stress, we’ve picked our 10 favourite cities worth visiting with the whole family";
    frm3DWithBurger.flexDummy.animate(kony.ui.createAnimation({
        100: {
            transform: trans
        }
    }), {
...
var txtArray = [{
    one: "Cometh the hour, Cometh the man. Virat Kohli put on a magnificent show with the bat for India as he blasted his 23rd century. For South Africa, AB de Villiers put on a brave show but his 22nd century could not help the Proteas get over the line. Catch all the moments of the match here.",
