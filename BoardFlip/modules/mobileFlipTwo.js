function flexflipper(container,front,back,sec,persp) {
...
function flexRotator(cont,below,above,t,persp){
  var trans1 = kony.ui.makeAffineTransform();
  trans1.rotate3D(180,1,0,0);
  frmHome.flexDummy.flexDummyTwo.transform=trans1;
  
  var side=0, inProgress=0, time=t/2;
